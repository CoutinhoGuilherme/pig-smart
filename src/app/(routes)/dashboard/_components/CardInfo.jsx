import { PiggyBank, ReceiptText, Wallet, Sparkle, CircleDollarSign, Sparkles } from "lucide-react";
...
function CardInfo({budgetList, incomeList}) {
    ...
    useEffect(() => {
        if(totalBudget.length > 0 || totalIncome.length > 0 || totalSpent > 0){
                    ...
                    <div className="mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        <div className="p-7 border rounded-2xl flex items-center justify-between">
                            <div>
                                ...
                                <h2 className="font-bold text-2xl">${formatNumber(budgetList.length)}</h2>
                            </div>
